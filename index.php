...
<body>
  ...
  <div id="page">
    ...
    <div id="left">
      ...
      <div id="popup-logout" onclick="closePopup(); return false;" data-queryElement="#popup-logout">
        <div class="popup-logout_content">
          <div>
            <svg viewBox="0 0 24 24" class="r-9uu7rm r-jwli3a r-4qtqp9 r-yyyyoo r-2pyi3h r-n6v787 r-1xvli5t r-dnmrzs r-u8s1d r-1plcrui r-uoibet r-lrvibr r-lrsllp" style="left: calc(17.5px);">
              <g>
    ...
    <div id="middle">
      ...
      <div class="view view_messages" id="middle-messages">
        <section id="middle_messages-section" style="display: block;">
          <div class="middle_messages-header">
            <h3 class="text-lg-dark-900">Messages</h3>
            <a href="/compose" onclick="return false;"><svg viewBox="0 0 24 24" class="r-13gxpu9 r-4qtqp9 r-yyyyoo r-1q142lx r-50lct3 r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-1srniue">
                <g>
          ...
          <div class="middle_messages-requests">
            <a href="/message-requests" onclick="return false;">
              <p> Message requests </p>
              <svg viewBox="0 0 24 24" class="r-1re7ezh r-4qtqp9 r-yyyyoo r-1q142lx r-1xvli5t r-dnmrzs r-1hfyk0a r-bnwqim r-1plcrui r-lrvibr">
                <g>
          ...
          <div class="middle_messages-search">
            <div>
              ...
              <form onsubmit="searchUser(); return false;">
                <input name="userSearch" type="text" placeholder="Search for people and groups">
              </form>
            </div>
          </div>
          <!-- TODO: append messages with people -->
          <div class="middle_messages-container">

          </div>
        </section>

        <section id="middle_write-section" style="display: none;">


          <div class="middle_texts-container">

          </div>
          <div class="middle_write-message">
      ...
      <div class="view" id="middle-profile">
        ...
        <section id="middle_profile-section">
          ...
          <article>
            ...
            <p class="user-joined"><svg viewBox="0 0 24 24" class="r-1re7ezh r-4qtqp9 r-yyyyoo r-1xvli5t r-7o8qx1 r-dnmrzs r-bnwqim r-1plcrui r-lrvibr">
                <g>
    ...
    <div class="modal-tweet_content">
      <form id="formTweet" onsubmit="createTweet(); return false;">
        ...
        <div class="tweet-controls">
          ...
          <button type="submit" data-queryElement="#modal-tweet" onclick="closeModal();" class="btn btn-tweet">Tweet</button>
        </div>
      </form>
    </div>
  </div>
        ...
        <div class="modal-profile_content-profile">
          <div>
            ...
            <div class="upload-image">
              <input class="select-img" type="file" name="userImage">
             
            </div>
          </div>
        </div>
        <input type="hidden" class="profile__country-previous" name="previousUserCountry" value="">
        <input type="hidden" class="profile__gender-previous" name="previousUserGender" value="">
        <div class="modal-profile_content-form">
          <div class="form-group profile__name-group">
          ...
          <div class="form-group">
            ...
            <select name="userCountry" class="profile__country-select">
              <!-- Add countries here -->
          ...
          <div class="form-group">
            ...
            <select name="userGender" class="profile__gender-select">
              <!-- Add genders here -->
